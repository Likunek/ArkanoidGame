...
namespace ArkanoidGame
{
    public class Physics
    {
        ...
        public CartesianPosition ExtractValue(bool HorizontalPosition, bool VerticalPosition, int position, int complication)
        {
            float X = new float();
            float Y = new float();
            ...
            X /= (tickRateValue - complication);
            Y /= (tickRateValue - complication);
